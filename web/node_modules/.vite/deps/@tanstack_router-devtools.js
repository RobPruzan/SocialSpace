import {
  ...
  useRouterState,
  useStore
} from "./chunk-Y2TA6CYP.js";
import {
  invariant
} from "./chunk-34INA4P6.js";
import "./chunk-JELW56M6.js";
import {
  require_react
...
function RouteComp({
  ...
  return import_react.default.createElement("div", null, import_react.default.createElement("div", {
    ...
    style: {
      ...
      alignItems: "center",
      background: route.id === activeRouteId ? "rgba(255,255,255,.1)" : void 0
    }
  ...
  }, `${route.path || trimPath(route.id)}`)), ((_a = route.children) == null ? void 0 : _a.length) ? import_react.default.createElement("div", {
    style: {
...
var TanStackRouterDevtoolsPanel = import_react.default.forwardRef(function TanStackRouterDevtoolsPanel2(props, ref) {
  ...
  const routerContextValue = import_react.default.useContext(routerContext);
  ...
  const allMatches = import_react.default.useMemo(() => [...Object.values(routerState.matches)], [routerState.matches]);
  const activeMatch = allMatches == null ? void 0 : allMatches.find((d) => d.routeId === activeRouteId);
  ...
  }, "Matches")), !showMatches ? import_react.default.createElement(RouteComp, {
    route: router.routeTree,
    isRoot: true,
    matches: allMatches,
    activeRouteId,
    setActiveRouteId
  }) : import_react.default.createElement("div", null, routerState.matches.map((match, i) => {
  ...
  }))), activeMatch ? import_react.default.createElement(ActivePanel, null, import_react.default.createElement("div", {
    style: {
      padding: ".5em",
      background: defaultTheme.backgroundAlt,
      position: "sticky",
  ...
  }, "Match Details"), import_react.default.createElement("div", null, import_react.default.createElement("table", null, import_react.default.createElement("tbody", null, import_react.default.createElement("tr", null, import_react.default.createElement("td", {
    style: {
      opacity: ".5"
    }
  ...
  }, "Status"), import_react.default.createElement("td", null, activeMatch.status)), import_react.default.createElement("tr", null, import_react.default.createElement("td", {
    style: {
      opacity: ".5"
    }
  }, "Last Updated"), import_react.default.createElement("td", null, activeMatch.updatedAt ? new Date(activeMatch.updatedAt).toLocaleTimeString() : "N/A"))))), import_react.default.createElement("div", {
    style: {
      background: defaultTheme.backgroundAlt,
      padding: ".5em",
      position: "sticky",
