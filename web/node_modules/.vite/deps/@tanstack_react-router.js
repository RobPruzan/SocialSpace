...
// node_modules/@tanstack/react-router/node_modules/@tanstack/store/build/esm/index.js
var _flush;
var Store = class {
  constructor(initialState, options) {
    __publicField(this, "listeners", /* @__PURE__ */ new Set());
    __publicField(this, "batching", false);
...
// node_modules/@tanstack/react-router/node_modules/@tanstack/router/build/esm/index.js
...
var Router = class {
  constructor(options) {
    ...
    __publicField(this, "hydrate", (dehydratedRouter) => {
      this.__store.setState((s) => {
    ...
    this.basepath = "";
    this.update(options);
    (_b = (_a = this.options).Router) == null ? void 0 : _b.call(_a, this);
...
var RouteMatch = class {
  constructor(router, route, opts) {
    ...
    __privateAdd(this, _hasLoaders, () => {
      return !!(this.route.options.onLoad || componentTypes.some((d) => {
        var _a;
      ...
      this.__loadPromise = Promise.resolve().then(async () => {
        ...
        const componentsPromise = (async () => {
          await Promise.all(componentTypes.map(async (type) => {
            ...
            if ((_a = this[type]) == null ? void 0 : _a.preload) {
...
// node_modules/@tanstack/react-router/node_modules/@tanstack/react-store/build/esm/index.js
var import_with_selector = __toESM(require_with_selector());
function useStore(store, selector = (d) => d, compareShallow) {
  const slice = (0, import_with_selector.useSyncExternalStoreWithSelector)(store.subscribe, () => store.state, () => store.state, selector, compareShallow ? shallow : void 0);
  return slice;
}
...
var ReactRouter = class extends Router {
  constructor(opts) {
    super({
      ...opts,
...
function useRouter(track, shallow2) {
  const router = useRouterContext();
  useStore(router.__store, track, shallow2);
  return router;
}
function useMatches() {
